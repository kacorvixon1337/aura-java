                                    ...
                                    for (Iterator<Object> it = objects.iterator(); it.hasNext(); ) {
                                        ...
                                        if (entity != null) {
                                            ...
                                            if (objStr.contains("MpServer")) {
                                                if(objStr.contains(otherPlayerClassName) && !objStr.contains("illilillil6756")){
                                                    ...
                                                    for(Method method : Killaura.methods){
                                                        ...
                                                        if(ModuleManager.killaura) {
                                                            ...
                                                            if (currentDist <= ModuleManager.reach) {
                                                    ...
                                                    /*Class<?> entityClass = entitu.getClass().getSuperclass().getSuperclass()
                    ...
                    for(Field field : clazz.getDeclaredFields()){
                        try {
                            ...
                            if (field.getType().getName().equals("double")) {
                                ...
                                if(doubleIndex == 9) Speed.motionX = field;
                                if(doubleIndex == 8) Speed.motionY = field;
                                if(doubleIndex == 6) Speed.motionZ = field;
                                ...
                                if(Speed.temp_x > 0){
                                    ...
                                    Speed.motionX.setDouble(instance, Speed.temp_x);
                                }
                                ...
                                if(Speed.temp_z > 0){
                                    ...
                                    Speed.motionZ.setDouble(instance, Speed.temp_z);
                                }

                                if(Speed.temp_y > 0) {

                                    //Vclip.motionY.setDouble(instance, motionY);
                                    Speed.motionY.setDouble(instance, Speed.temp_y);
                                }
